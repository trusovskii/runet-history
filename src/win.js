...
window.addEventListener("DOMContentLoaded", () => {
  try {
    ...
    if (score >= 56) {
      ...
      strings.text = `
      <p class="results__text">Вы&nbsp;видали в&nbsp;гробу историю Рунета. А&nbsp;может&nbsp;&mdash; выросли в&nbsp;глухом домике возле леса, где надо залезть на&nbsp;берёзку, чтобы поймать сигнал. Факт остаётся фактом: вы&nbsp;не&nbsp;такой, как все. От&nbsp;души поздравляем.</p>
      <p class="results__text">Если вам провести интернет, вы&nbsp;вряд&nbsp;ли тут&nbsp;же победите онлайн-тролля в&nbsp;словесном самбо. Но&nbsp;начнёте путешествие в&nbsp;дивный новый мир сети. Там кроме информационного мусора, диванных войск и&nbsp;анонимусов есть масса чего забавного и&nbsp;прекрасного.</p>
      `;
    }
